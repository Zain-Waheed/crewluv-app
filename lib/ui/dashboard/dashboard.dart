         ...
         floatingActionButton: Container(
           ...
           child: FloatingActionButton(
             child: Center(child: Image.asset(
               AppImages.addEvent, scale: 2.5, color: AppColors.whiteColor,)),
               ...
               child: Row(
                 ...
                 children: [
                   GestureDetector(
                     ...
                     child: Image.asset(AppImages.home, scale: 3.2,
                   ...
                   GestureDetector(
                     ...
                     child: Image.asset(AppImages.people, scale: 3.2,
                   ...
                   Image.asset(
                     AppImages.user, scale: 3, color: Colors.transparent,),
                   Image.asset(
                     AppImages.user, scale: 3, color: Colors.transparent,),
                   GestureDetector(
                       onTap: () {
                   ...
                   GestureDetector(
                       ...
                       child: Image.asset(AppImages.user, scale: 3.2,
