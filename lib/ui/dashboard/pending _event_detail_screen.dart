...
class PendingEventDetail extends StatefulWidget {
 final  UserModel user;
 final EventModel event;
  const PendingEventDetail({Key? key, required this.user, required this.event}) : super(key: key);

  @override
  _PendingEventDetailState createState() => _PendingEventDetailState();
}

class _PendingEventDetailState extends State<PendingEventDetail> {
  bool pressed = false;
  @override
