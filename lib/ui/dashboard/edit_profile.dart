            ...
            children: [
              ...
              ElevatedButton(
                style: ButtonStyle(
                  ...
                  backgroundColor: MaterialStateProperty.all(AppColors.offWhite),
                ),
                onPressed: (){},
                  child:  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        Image.asset(AppImages.instagram,scale: 4,),
                        SizedBox(
                          width: Get.width*0.02,
                        ),
                        Text(
                          getTranslated(context, 'connect_instagram')??"",
                          style: AppTextStyle.montserrat(AppColors.blackLite, Get.width*0.04, FontWeight.w400),
                        ),
                      ],
                    ),
                  ),
              ...
              AppButton(buttonText: 'save_changes', onpressed: (){}, width: Get.width*1, isWhite: false),
              SizedBox(
                height: Get.width*0.05,
              ),
            ],
