          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          Spacer(),
                          Text(provider.phone,style: AppTextStyle.montserrat(AppColors.shadedBlack, Get.width*0.035, FontWeight.w500),),
                ...
                settingsWidget(AppImages.subscription2,'subscription' , () { Get.dialog( GetPlanDialogBox()); }),
