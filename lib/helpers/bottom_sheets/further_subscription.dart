          ...
          child: Column(
            children: [
              ...
              Row(
                children: [
                  Container(
                    ...
                    child: Image.asset(AppImages.smallLogo,height: Get.width*0.15,width: Get.width*0.2,fit: BoxFit.cover,),
                  ),
              ...
              AppButton(buttonText: 'subscribe_now', onpressed: (){
                Get.back();
                Get.bottomSheet(CongraulationBottomSheet(text: 'you_have_successfully',));
